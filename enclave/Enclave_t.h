...
sgx_status_t upload_encoded_query_data(uint8_t* total_query_data, size_t toal_size, size_t client_size, uint64_t* query_id_list);
...
sgx_status_t private_encode_contact_trace(uint8_t* encoded_value_u8, size_t encoded_value_u8_size, size_t epoch_data_size);
sgx_status_t get_result(uint8_t* response, size_t response_size);
sgx_status_t get_encoded_result(uint8_t* response, size_t response_size);
